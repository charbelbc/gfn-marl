...
class Mission(np.ndarray):
    ...
    def __reduce__(self):
        """
        Tell pickle exactly how to reconstruct the object.
        """
        return (self.__class__, (self.string, np.asarray(self)))
...
class MissionSpace(spaces.MultiDiscrete):
    ...
    def from_string(string: str) -> MissionSpace:
        ...
        return MissionSpace(mission_func=partial(_return_string, string))


def _return_string(string: str) -> str:
    return string
