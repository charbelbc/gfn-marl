...
from env.multigrid.core.constants import Color, Direction, Type
from env.multigrid.core.mission import MissionSpace, Mission
from env.multigrid.core.roomgrid import RoomGrid
from env.multigrid.core.world_object import Ball
...
class BlockedUnlockPickupEnv(RoomGrid):
    ...
    * ``MultiGrid-BlockedUnlockPickup-v0``
    ...
    def _gen_grid(self, width, height):
        ...
        self.mission = f"pick up the {self.obj.color.name} {self.obj.type.name}"
